...
<div class="container">
    <div class="trending-wrapper">
        ...
        <div class="row">
            @foreach($products as $item)
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-0  "> <!-- Responsive column classes -->
                <div class="card trending-item p-2 text-center">
                    <a href="detailwatch/{{$item['id']}}" class="text-decoration-none text-dark">
